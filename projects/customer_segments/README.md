...
Template code is provided in the `customer_segments.ipynb` notebook file. The `visuals.py` Python file and the `customers.csv` dataset file will be requiered to complete the project.
